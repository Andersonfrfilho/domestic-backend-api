...
@Module({
  ...
  providers: [
    ...
    {
      provide: SERVICE_REQUEST_LIST_BY_USER_USE_CASE_PROVIDE,
      useClass: ListServiceRequestsByUserUseCase,
    },
    {
      provide: SERVICE_REQUEST_LIST_BY_PROVIDER_USE_CASE_PROVIDE,
      useClass: ListServiceRequestsByProviderUseCase,
    },
